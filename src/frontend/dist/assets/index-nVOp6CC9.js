...
function parseUrlParams() {
  ...
  return {
    ...
    studyMin: params.has("study") ? Math.max(1, Number.parseInt(params.get("study"), 10)) : null,
    breakMin: params.has("break") ? Math.max(1, Number.parseInt(params.get("break"), 10)) : null,
    sessions: params.has("sessions") ? Math.max(1, Number.parseInt(params.get("sessions"), 10)) : null,
    currentSession: params.has("current") ? Math.max(1, Number.parseInt(params.get("current"), 10)) : null,
    ...
    sessionStroke: params.has("sessionStroke") ? Math.min(
      3,
...
function saveSessionControl(current, total) {
  try {
...
function loadStoredSessionStyle() {
  try {
...
function saveSessionStyle(style2) {
  try {
    localStorage.setItem("sessionTextColor", style2.sessionTextColor);
    localStorage.setItem("sessionOutlineColor", style2.sessionOutlineColor);
    localStorage.setItem(
      "sessionOutlineThickness",
      String(style2.sessionOutlineThickness)
    );
  } catch {
  }
}
function loadStoredModeStyle() {
  try {
...
function saveModeStyle(style2) {
  try {
    localStorage.setItem("pomodoro_mode_style", JSON.stringify(style2));
  } catch {
  }
}
...
function App() {
  const urlParams = reactExports.useRef(parseUrlParams());
  const resolveInitialSettings = () => {
    const stored = loadStoredSettings();
    const studyVal = urlParams.current.studyMin ?? (stored == null ? void 0 : stored.study) ?? 25;
    const breakVal = urlParams.current.breakMin ?? (stored == null ? void 0 : stored.break) ?? 5;
    const sessionsVal = urlParams.current.sessions ?? (stored == null ? void 0 : stored.sessions) ?? 7;
    return {
  ...
  const resolveInitialSessionControl = () => {
    ...
    const total = totalFromUrl ?? (stored == null ? void 0 : stored.total) ?? 7;
    const current = currentFromUrl ?? (stored == null ? void 0 : stored.current) ?? 1;
    return {
  ...
  const resolveInitialSessionStyle = () => {
    const stored = loadStoredSessionStyle();
    return {
      sessionTextColor: urlParams.current.sessionColor ?? (stored == null ? void 0 : stored.sessionTextColor) ?? DEFAULT_SESSION_STYLE.sessionTextColor,
      sessionOutlineColor: urlParams.current.sessionOutline ?? (stored == null ? void 0 : stored.sessionOutlineColor) ?? DEFAULT_SESSION_STYLE.sessionOutlineColor,
      sessionOutlineThickness: urlParams.current.sessionStroke ?? (stored == null ? void 0 : stored.sessionOutlineThickness) ?? DEFAULT_SESSION_STYLE.sessionOutlineThickness
    };
  };
  const resolveInitialModeStyle = () => {
    const stored = loadStoredModeStyle();
    return {
      modeColor: urlParams.current.modeColor ?? (stored == null ? void 0 : stored.modeColor) ?? DEFAULT_MODE_STYLE.modeColor,
      modeOutlineColor: urlParams.current.modeOutline ?? (stored == null ? void 0 : stored.modeOutlineColor) ?? DEFAULT_MODE_STYLE.modeOutlineColor,
      modeOutlineThickness: (stored == null ? void 0 : stored.modeOutlineThickness) ?? DEFAULT_MODE_STYLE.modeOutlineThickness
    };
  };
  const [studyInput, setStudyInput] = reactExports.useState(initialSettings.study);
  const [breakInput, setBreakInput] = reactExports.useState(initialSettings.break);
  const [sessionsInput, setSessionsInput] = reactExports.useState(
    initialSettings.sessions
  );
  const [currentSessionInput, setCurrentSessionInput] = reactExports.useState(
    String(initialSessionControl.current)
  );
  const [totalSessionsInput, setTotalSessionsInput] = reactExports.useState(
    String(initialSessionControl.total)
  );
  const [sessionStyle, setSessionStyle] = reactExports.useState(
    resolveInitialSessionStyle
  );
  const [modeStyle, setModeStyle] = reactExports.useState(
    resolveInitialModeStyle
  );
  const [showSettings, setShowSettings] = reactExports.useState(false);
  const [isTransparent, setIsTransparent] = reactExports.useState(
    urlParams.current.transparent
  );
  const [copyLabel, setCopyLabel] = reactExports.useState("COPY LINK");
  const [visualMode, setVisualMode] = reactExports.useState("study");
  const [transitioning, setTransitioning] = reactExports.useState(false);
  const pendingStudyRef = reactExports.useRef(
    Math.max(1, Number.parseInt(initialSettings.study) || 25)
  );
  const pendingBreakRef = reactExports.useRef(
    Math.max(1, Number.parseInt(initialSettings.break) || 5)
  );
  const pendingSessionsRef = reactExports.useRef(
    Math.max(1, Number.parseInt(initialSettings.sessions) || 7)
  );
  const pendingCurrentSessionRef = reactExports.useRef(initialSessionControl.current);
  const pendingTotalSessionsRef = reactExports.useRef(initialSessionControl.total);
  reactExports.useEffect(() => {
  ...
  const [timerState, setTimerState] = reactExports.useState(initState);
  const timerStateRef = reactExports.useRef(timerState);
  ...
  reactExports.useEffect(() => {
    if (timerState.timeLeft === 0 && !timerState.isRunning && wasRunningRef.current && !advancedRef.current) {
  ...
  const handleCopyLink = () => {
    ...
    navigator.clipboard.writeText(url).then(() => {
      setCopyLabel("COPIED!");
      setTimeout(() => setCopyLabel("COPY LINK"), 2e3);
    }).catch(() => {
      setCopyLabel("COPIED!");
      setTimeout(() => setCopyLabel("COPY LINK"), 2e3);
    });
  ...
  const totalDuration = mode === "study" ? pendingStudyRef.current * 60 : pendingBreakRef.current * 60;
  ...
  const sessionTextStroke = sessionStyle.sessionOutlineThickness > 0 ? `${sessionStyle.sessionOutlineThickness}px ${sessionStyle.sessionOutlineColor}` : "none";
  ...
  const modeTextStroke = modeStyle.modeOutlineThickness > 0 ? `${modeStyle.modeOutlineThickness}px ${modeStyle.modeOutlineColor}` : "none";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: `pomodoro-card ${isTransparent ? "no-bg" : "has-bg"} ${transitioning ? "mode-transitioning" : ""}`,
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    session,
                    "/",
                    pendingTotalSessionsRef.current
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "timer-display", "data-ocid": "pomodoro.panel", children: formatTime(timeLeft) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "progress-track", "data-ocid": "pomodoro.row", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: `progress-fill ${visualMode === "study" ? "study-mode" : "break-mode"}`,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: visualMode === "study" ? "STUDY" : "BREAK"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "controls-row", "data-ocid": "pomodoro.section", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    className: `ctrl-btn primary ${visualMode === "break" ? "break-active" : ""}`,
                    onClick: handleStartPause,
                    "data-ocid": isRunning ? "pomodoro.secondary_button" : "pomodoro.primary_button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "utility-row", "data-ocid": "pomodoro.section", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    children: isTransparent ? "BG OFF" : "BG ON"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                ...
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-grid", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "settings-section-title", children: "Session Control" }),
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "settings-section-title", children: "Session Text Style" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "color-picker-field", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "label",
                          {
                            htmlFor: "setting-session-color",
                            className: "settings-label",
                            children: "Session Text Color"
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "input",
                          {
                            ...
                            onChange: (e) => setSessionStyle((prev) => ({
                              ...prev,
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "color-picker-field", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "label",
                          {
                            ...
                            className: "settings-label",
                            children: "Session Outline Color"
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "input",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-field", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "label",
                          {
                            ...
                            children: [
                              "Session Outline (",
                              sessionStyle.sessionOutlineThickness,
                              "px)"
                            ]
                          }
                        ),
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "settings-section-title", children: "Mode Text Style" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "color-picker-field", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "setting-mode-color", className: "settings-label", children: "Mode Text Color" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "input",
                          {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-field", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "label",
                          {
                            ...
                            children: [
                              "Mode Outline (",
                              modeStyle.modeOutlineThickness,
                              "px)"
                            ]
                          }
                        ),
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "settings-section-title", children: "Timer Settings" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-field", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "setting-study", className: "settings-label", children: "Study Time (min)" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "input",
                          {
                            id: "setting-study",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-field", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "setting-break", className: "settings-label", children: "Break Time (min)" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "input",
                          {
                            id: "setting-break",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-field", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "setting-sessions", className: "settings-label", children: "Default Sessions" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "input",
                          {
                            id: "setting-sessions",
                    ...
                    isRunning && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "settings-hint", children: "Timer changes apply after current cycle" })
                  ]
                }
              )
            ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `footer-text ${isTransparent ? "no-bg" : ""}`, children: [
      "© ",
